      ...
      <div className="w-full max-w-md bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Email */}
            <p className="w-full px-4 py-2.5 text-sm bg-slate-100 rounded border border-gray-300 text-slate-500 cursor-not-allowed">
              {formData.email}
            </p>
            ...
            {/* Profile Image */}
            <div className="pt-1">
              <label className="block text-sm text-gray-600 mb-2 px-1">
                Profile Image
              </label>
                ...
                {formData.profile_img && (
                  <div className="shrink-0 flex flex-row gap-2 items-center">
                    <img
                      ...
                      alt="Profile"
                      className="h-10 w-10 object-cover rounded-md border border-dashed"
                    />
                    <FaTimes
                      className="w-10 h-10 p-3 bg-red-200 hover:bg-red-300 text-red-600 rounded-lg cursor-pointer"
                      onClick={clearFile}
                    />
                  </div>
                )}
